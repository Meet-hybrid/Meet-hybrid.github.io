  ...
  <div class="container">
    ...
    <div class="posts-grid">
      <article class="post-card">
        ...
        <div class="post-card__meta"><a href="{{ '/guides' | relative_url }}" class="btn btn--primary btn--sm" style="font-size:0.75rem;">View</a></div>
      </article>
    ...
    <div style="text-align:center;margin-top:40px;">
      <a href="{{ '/guides' | relative_url }}" class="btn btn--outline">View All Guides →</a>
    </div>
  </div>
</section>
